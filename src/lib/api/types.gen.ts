...
export type GetTodayStoreVisitsData = {
  body?: never;
  path: {
    storeId: number;
  };
...
export type GetTodayStoreVisitsResponses = {
  /**
   * OK
   */
...
export type GetTodayStoreVisitsResponse =
  GetTodayStoreVisitsResponses[keyof GetTodayStoreVisitsResponses];
